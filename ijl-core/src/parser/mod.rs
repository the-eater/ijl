    ...
    I: ValueInput<'tokens, Token = Token<'src>, Span = SimpleSpan>,
{
    ...
    let full_expr = access.pratt((
        ...
        infix(left(49), if_as(Token::Asterisk, InfixType::Multiply).or(if_as(Token::Slash, InfixType::Divide)).or(if_as(Token::Percentage, InfixType::Modulo)).or(if_as(Token::DoubleAsterisk, InfixType::Power)), make_infix),
        ...
        infix(left(42), if_as(Token::DoubleAmpersand, InfixType::LogicalAnd), make_infix),
